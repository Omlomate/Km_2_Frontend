...
const CreateForum = ({ onAddPost }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Call the onAddPost function passed from parent component
    onAddPost(newPost);
