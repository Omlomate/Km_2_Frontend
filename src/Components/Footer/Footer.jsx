  ...
  const socialItems = [
    {
      name: "Facebook",
      key: "Facebook",
      url: socialLinks.Facebook || "https://www.facebook.com/people/Keyword-Raja/61574543301396/",
      icon: (
    ...
    },
    {
      name: "LinkedIn",
      key: "LinkedIn",
      url: socialLinks.LinkedIn || "https://www.linkedin.com/showcase/keywordraja/",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="w-full md:w-3/4 col-span-1 space-y-6">
            <div className="flex items-center flex-shrink-0 text-gray-700 mb-4">
              <a
                href="/"
                className="flex items-center gap-2 logo-hover transition-transform hover:scale-105"
              >
                <svg
