    ...
    <footer className="bg-white text-gray-600 py-8 md:py-16">
      <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-8 sm:gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M19 5v14H5V5h14m1.1-2H3.9c-.5 0-.9.4-.9.9v16.2c0 .4.4.9.9.9h16.2c.4 0 .9-.5.9-.9V3.9c0-.5-.5-.9-.9-.9zM11 7h6v2h-6V7zm0 4h6v2h-6v-2zm0 4h6v2h-6v-2zM7 7h2v2H7V7zm0 4h2v2H7v-2zm0 4h2v2H7v-2z"
                        fill="currentColor"
                      />
                    </svg>
                    Blog
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-3">
                  <a
                    href="#"
                    className="text-gray-500 hover:text-[#E5590F] transition-colors"
                    aria-label="Facebook"
                  >
                    <svg
                      className="w-5 h-5"
        ...
        <div className="flex flex-wrap gap-2 justify-center md:justify-start">
            <div className="flex flex-wrap gap-4 justify-center md:justify-start mb-4 md:mb-6">
              <Link
                to="/privacy"
