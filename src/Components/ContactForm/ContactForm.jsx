  ...
  return (
    <div className="flex flex-col mt-4 mb-4 md:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-8 p-4 sm:p-6 md:p-8 bg-white rounded-xl shadow-sm border border-gray-100 max-w-6xl mx-auto">
      ...
      <div className="w-full md:w-3/5">
        <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-[#12153D]">Get in touch</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <textarea
            ...
            placeholder="Message"
            rows="4"
            className="w-full px-4 py-3 bg-gray-50 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E5590F] transition-all duration-300 border border-transparent focus:border-[#E5590F]/30 resize-y min-h-[100px]"
            required
          ></textarea>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 items-center justify-center">
            <button
              type="submit"
              className="w-full sm:w-1/2 py-3 bg-[#E5590F] text-white font-medium rounded-lg hover:bg-[#E5590F]/90 transition duration-300 focus:outline-none focus:ring-2 focus:ring-[#E5590F] focus:ring-offset-2 transform hover:-translate-y-0.5"
            >
              Send Message
            </button>
