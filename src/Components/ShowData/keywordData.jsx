...
const KeywordData = () => {
  ...
  // Fetch meta tags for the Home page
  useEffect(() => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setKeywordData({
        ...
        volume: volumeDifficultyResponse.data.analysisResult.keywordVolume,
        difficulty:
          volumeDifficultyResponse.data.analysisResult.keywordDifficulty,
      });
    } catch (error) {
      ...
      <div className="w-full bg-white grid grid-cols-1 pr-4 pl-4 rounded-lg animate-fade-in">
        {isSignupVisible ? (
          ...
          <>
            ...
            <div
              className="w-full max-w-full mt-4 mx-auto shadow-sm p-1 rounded-lg flex items-center border-1 border-gray-500"
                    ...
                    <div className="w-full sm:w-1/2 h-full border-1 border-gray-500 p-3 sm:p-4 rounded-lg mb-3 sm:mb-0">
                      <div className="p-2 sm:p-4 shadow-lg rounded-lg">
                        <h1 className="text-base sm:text-lg text-bold break-words">
                          <span className="text-[#E5590F] font-bold">
                            {keywordData.relatedKeywordsCount}
                          </span>{" "}
                          results for{" "}
                          <span className="font-bold text-[#12153d] break-all">
                            {searchTerm}
                          </span>
                        </h1>
                      </div>
                    ...
                    <div className="w-full sm:w-1/2 sm:pl-3">
                      ...
                      <div className="mt-3 sm:mt-4" style={{ fontFamily: "wantedsans" }}>
                        <div className="h-20 sm:h-25 bg-[#12153d] text-white text-center pt-3 sm:pt-5 rounded-t-lg">
                          ...
                          <p
                            className="text-base text-[#E5590F] sm:text-2xl font-bold"
                            style={{ fontFamily: "Space Grotesk, sans-serif" }}
                          >
                          ...
                          <div className="absolute rounded-b-lg inset-0 flex items-center justify-center bg-[#12153d] text-white text-lg transition-opacity duration-500 ease-in-out z-20 opacity-0 hover:opacity-100">
                            <div className="flex flex-col items-center p-4">
                              <h1 className="text-sm sm:text-lg text-bold">
                                ...
                                <span className="text-orange-500">keyword is searched</span> in a
                                given time period
                              </h1>
                            </div>
                          </div>
                      ...
                      <div className="mt-3 sm:mt-4" style={{ fontFamily: "wantedsans" }}>
                        <div className="h-25 bg-[#12153d] text-white text-center pt-5 rounded-t-lg">
                          <h1 className="text-lg sm:text-xl font-bold">Keyword Difficulty</h1>
                          <p
                            className="text-lg text-[#E5590F] sm:text-2xl font-bold"
                            style={{ fontFamily: "Space Grotesk, sans-serif" }}
                          >
                          ...
                          <div className="absolute rounded-b-lg inset-0 flex items-center justify-center bg-[#12153d] text-white text-lg transition-opacity duration-500 ease-in-out z-20 opacity-0 hover:opacity-100">
                            <div className="flex flex-col items-center p-4">
                              <h1 className="text-sm sm:text-lg text-bold">
                                ...
                                <span className="text-orange-500">challenging</span> it would be
                                to{" "}
                                <span className="text-orange-500">rank organically</span> for
                                this keyword
                              </h1>
                            </div>
                          </div>
            ...
            <div className="w-full relative h-24 sm:h-30 mt-4 hidden sm:block" id="hover">
              <div className="absolute rounded-lg h-full inset-0 flex items-center justify-center border-1 border-gray-500 text-white text-lg transition-opacity duration-300 ease-in-out z-10 opacity-100 hover:opacity-0 p-3 sm:p-4 md:p-10" style={{ fontFamily: "wantedsans" }}>
                <div className="items-center">
                  <p className="text-black text-xs sm:text-md md:text-lg p-1 sm:p-2 lg:text-xl text-center">
                    Want to grow your business, your social media with the right advertising
                    and marketing and much more with Keyword Raja?
                  </p>
                </div>
              </div>
