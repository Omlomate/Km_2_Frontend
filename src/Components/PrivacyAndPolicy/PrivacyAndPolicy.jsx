...
const PrivacyAndPolicy = () => {
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <h1 className="text-3xl font-bold text-center mb-8 text-[#12153D]">
        Privacy Policy
      </h1>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-3 text-[#12153D]">
            Interpretation and Definitions
          </h2>
          <h3 className="text-lg font-medium mb-2 text-[#12153D]">
            Interpretation
          </h3>
          <p className="text-gray-700 mb-2">
          ...
          <h3 className="text-lg font-medium mb-2 mt-4 text-[#12153D]">
            Definitions
          </h3>
          <p className="text-gray-700 mb-2">
          ...
          <ul className="list-disc pl-6 text-gray-700 mb-2">
            ...
            <li className="mb-2">
              <span className="font-medium">Affiliate</span> means an entity
            ...
            <li className="mb-2">
              ...
              refers to Kolorowey Media, New Delhi, India.
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">
              <span className="font-medium">Country</span> refers to: Delhi,
              India
            </li>
            <li className="mb-2">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <ul className="list-disc pl-6 text-gray-700 mb-6">
          ...
          <li className="mb-2">
            <span className="font-medium">Website</span> refers to Keyword Raja, accessible from <a href="https://keywordraja.com" className="text-blue-600 hover:underline">https://keywordraja.com</a>
          </li>
          <li className="mb-2">
        ...
        <section className="mb-6">
          ...
          <h4 className="text-base font-medium mb-2 text-[#12153D]">
            Personal Data
          </h4>
          <p className="text-gray-700 mb-2">
          ...
          <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <li className="mb-1">Address, State, Province, ZIP/Postal code, City</li>
            <li>Usage Data</li>
          </ul>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <section className="mb-6">
          ...
          <h3 className="text-lg font-medium mb-3 text-[#12153D]">
          ...
          <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <li className="mb-3">
              <span className="font-medium">Web Beacons.</span> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).
            </li>
          </ul>
          ...
          <div className="mb-4">
            ...
            <p className="text-gray-700 mb-1">Type: Session Cookies</p>
            <p className="text-gray-700 mb-1">Administered by: Us</p>
          ...
          <div className="mb-4">
            ...
            <p className="text-gray-700 mb-1">Type: Persistent Cookies</p>
            <p className="text-gray-700 mb-1">Administered by: Us</p>
            <p className="text-gray-700 mb-3">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <section className="mb-6">
          ...
          <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <li className="mb-2">With other users: when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You and view Your profile.</li>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 mb-2">
            <li className="mb-2">By email: support@keywordraja.com</li>
            <li className="mb-2">By visiting this page on our website: <a href="https://keywordraja.com/contact-us" className="text-blue-600 hover:underline">https://keywordraja.com/contact-us</a></li>
          </ul>
        </section>
      </div>
    </div>
